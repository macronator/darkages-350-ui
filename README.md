...
client/             C# (.NET) render harness: reconstructs the play screen from ui-350.json (cross-platform, headless PNG)
shell/              C# (WinForms) live client shell: interactive window driven by ui-350.json (Windows)
```
